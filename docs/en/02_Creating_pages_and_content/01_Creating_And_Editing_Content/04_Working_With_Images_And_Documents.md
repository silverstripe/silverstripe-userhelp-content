...
This same process can be used for filetypes other than images as well, which we will cover in [Uploading and Linking to Documents](https://userhelp.silverstripe.org/en/3.3/creating_pages_and_content/creating_and_editing_content/working_with_images_and_documents/).
</div>
